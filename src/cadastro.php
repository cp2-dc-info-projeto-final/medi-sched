      ...
      <div id="signup">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
          <div class="field-wrap">
            <input type="text" required placeholder="First Name" name="nome">
          </div>
          <div class="field-wrap">
            <input type="email" required placeholder="Email Address" name="email">
          </div>
          <div class="field-wrap">
            <input type="password" required placeholder="Password" name="senha">
          </div>
          <div class="field-wrap">
            <input type="text" required placeholder="CPF" name="cpf" maxlength="14" oninput="formatarCPF(this)">
          </div>
          <div class="field-wrap">
            <input type="date" required placeholder="Date of Birth" name="data_nascimento">
          </div>
