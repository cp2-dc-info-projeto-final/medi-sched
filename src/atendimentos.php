            ...
            <div class="col-12 col-sm-6 col-md-3 m-auto tamanho">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <hr class="mx-auto w-75">
                        <p>
                        Procedimentos como hemogramas, exames de urina, 
                        e testes de colesterol que ajudam na detecção precoce de doenças.
                        </p>
                    </div>
                </div>
                <!-- card ends here -->
            ...
            <div class="col-12 col-sm-6 col-md-3 m-auto tamanho">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <hr class="mx-auto w-75">
                        <p>
                        Serviços para condições que não são ameaças à vida, mas que requerem atenção rápida, 
                        como cortes que precisam de suturas, infecções leves ou febres altas.
                        </p>
                    </div>
                </div>
                <!-- card ends here -->
            ...
            <div class="col-12 col-sm-6 col-md-3 m-auto tamanho">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <hr class="mx-auto w-75">
                        <p>
                        Avaliação preventiva anual para verificar o estado de saúde geral do paciente, incluindo exames de sangue, 
                        aferição de pressão arterial, e outros testes específicos conforme a idade e o risco do paciente.
                        </p>
                        <br>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-3 m-auto tamanho">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <hr class="mx-auto w-75">
                        <p>
                        Administração de vacinas para prevenir doenças infecciosas, 
                        seguindo o calendário de vacinação recomendado para diferentes faixas etárias e condições de saúde.
                        </p>
                    </div>
                </div>
                <!-- card ends here -->
            ...
            <div class="col-12 col-sm-6 col-md-3 m-auto tamanho">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <hr class="mx-auto w-75">
                        <p>
                        Acompanhamento regular e tratamento de doenças crônicas como diabetes, hipertensão e asma, 
                        incluindo ajuste de medicamentos, educação para autocontrole e monitoramento de complicações.
                        </p>
                    </div>
                </div>
                <!-- card ends here -->
        ...
        <div class="col-12 col-sm-6 col-md-3 m-auto tamanho">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <hr class="mx-auto w-75">
                        <p>
                        Consultas com psicólogos ou psiquiatras para abordar questões de saúde mental, como depressão, 
                        ansiedade e transtornos de humor, oferecendo terapia e medicamentos conforme necessário.
                        </p>
                    </div>
                </div>
                <!-- card ends here -->
    ...
    <div class="col-12 col-sm-6 col-md-3 m-auto tamanho">
                ...
                <a href="#" class="topo-link">&#9650;</a>
                    ...
                    <div class="card-body">
                        ...
                        <hr class="mx-auto w-75">
                        <p>
                        Atendimento especializado focado em ginecologia e obstetrícia, incluindo exames pélvicos, Papanicolau, 
                        orientação contraceptiva, cuidados pré-natais e acompanhamento da menopausa.
                        </p>
                    </div>
                </div>
